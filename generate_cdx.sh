...
SIXDAYSAGOCDX="`dirname $CDXFILE`/sixdaysago.cdx"
...
SIXDAYSAGOPATHINDEX="`dirname $PATH_INDEX`/path-index6.txt"
...
cat $ONEDAYAGOPATHINDEX $TWODAYSAGOPATHINDEX $THREEDAYSAGOPATHINDEX $FOURDAYSAGOPATHINDEX $FIVEDAYSAGOPAHINDEX >> $TEMPFILE
...
rm $CDXTEMPFILE
rm $SIXDAYSAGOCDX
rm $SIXDAYSAGOPATHINDEX
mv $FIVEDAYSAGOCDX $SIXDAYSAGOCDX
...
mv $FIVEDAYSAGOPATHINDEX $SIXDAYSAGOPATHINDEX
